...
public:
  ...
  void enterAmount()
  {
      ...
      next = new Fl_Button(240,195,100,25,"Enter");
      // ext->callback(next_cb);
  ...
  void createAccount(info &person)
  {
    ...
    Fl_Input *fname = new Fl_Input(110,100,130,25,"First Name ");person.fname = fname->value();
    ...
    Fl_Button *next = new Fl_Button(440,365,100,25,"Next");
    // Fl_Button *back = new Fl_Button(330,365,100,25,"Back"); back->callback(back_cb);
    g->labelsize(14);
    g->end();
    // return info;
